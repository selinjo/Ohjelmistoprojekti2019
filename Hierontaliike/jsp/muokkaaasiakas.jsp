...
<fieldset id="muokkaaAsiakas" class="container">
	<legend>Muokkaa asiakasta <%out.print(asiakas.getEtunimi() + " " + asiakas.getSukunimi());%></legend>
	<form action="Servlet_MuokkaaAsiakas" method="post" id="muokkaaAsiakasLomake">
		...
		<label></label>	
			<input type="submit" value="Vahvista muutos" id="muokkaaAsiakasBtn" class="btn btn-success">
...
$("#peruutaBtn").click(function(){	
	document.location="asiakkaat.jsp";
});
</script>
</body>
</html>
