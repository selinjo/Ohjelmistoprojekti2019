...
if(request.getAttribute("hieroja")==null) {
	response.sendRedirect("Servlet_MuokkaaHierojaTiedot");
	return;
}else if( request.getAttribute("hieroja")!=null){
...
<fieldset id="muokkaaHieroja" class="container">
	...
	<form action="Servlet_MuokkaaHieroja" method="post" id="muokkaaHierojaLomake">
		...
		<label></label>	
			<input type="submit" value="Vahvista muutokset" id="muokkaaHierojaBtn" class="btn btn-success">
